...
export default function Home() {
  return (
    <main className="flex flex-col items-center justify-center text-center max-w-4xl mx-auto py-24 px-4 sm:px-6 lg:px-8">
      ...
      <Link href="/users">
        <Button size="lg" className="text-base px-6 py-4 flex flex-row gap-2 justify-center items-center bg-purple-700 text-white rounded-md hover:bg-transparent hover:text-purple-700 border border-purple-700 transition text-center">
